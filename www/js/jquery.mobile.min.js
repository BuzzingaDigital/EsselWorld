/*! jQuery Mobile vGit Build: SHA1: 4895716227c7415df8a7268a0ec22e8d904f5df6 <> Date: Thu Nov 1 23:39:03 2012 +0100 jquerymobile.com | jquery.org/license !*/
(function (a, b, c) {
    ...
    function (a, b) {
        ...
        a.widget("mobile.loader", {
            ...
            hide: function () {
                e.removeClass("ui-loading"), a.mobile.loadingMessage && this.element.removeClass("ui-loader-fakefix"), a(b).unbind("scroll", this.fakeFixLoader), a(b).unbind("scroll", this.checkLoaderPosition)
            }
        ...
        var e = a(b),
            ...
            h = {
                ...
                convertUrlToDataUrl: function (a) {
                    var c = h.parseUrl(a);
                    return h.isEmbeddedPage(c) ? c.hash.split(n)[0].replace(/^#/, "").replace(/\?.*$/, "") : h.isSameDomain(c, q) ? c.hrefNoHash.replace(q.domain, "").split(n)[0] : b.decodeURIComponent(a)
                },
                get: function (a) {
    ...
    function (a, b) {
        ...
        function e(c, d, e, f, g) {
            var h = a.data(c[0], "buttonElements");
            c.removeClass(d).addClass(e), h && (h.bcls = c[0].className, f !== b && (h.hover = f), h.state = g)
        }
        a.fn.buttonMarkup = function (d) {
            ...
            for (var h = 0; h < e.length; h++) {
                ...
                u || j.appendChild(r), u = {
                    ...
                    text: s,
                    icon: t
                }, a.data(j, "buttonElements", u), a.data(r, "buttonElements", u), a.data(s, "buttonElements", u), t && a.data(t, "buttonElements", u)
            }
            return this
        ...
        var f = function () {
            var g = a.mobile.buttonMarkup.hoverDelay,
                h, i;
            a(c).bind({
                "vmousedown vmousecancel vmouseup vmouseover vmouseout focus blur scrollstart": function (c) {
                    var f, j = a(d(c.target)),
                        k = c.originalEvent && /^touch/.test(c.originalEvent.type),
                        l = c.type;
                    if (j.length) {
                        f = j.attr("data-" + a.mobile.ns + "theme");
                        if (l === "vmousedown") k ? h = setTimeout(function () {
                            e(j, "ui-btn-up-" + f, "ui-btn-down-" + f, b, "down")
                        }, g) : e(j, "ui-btn-up-" + f, "ui-btn-down-" + f, b, "down");
                        else if (l === "vmousecancel" || l === "vmouseup") e(j, "ui-btn-down-" + f, "ui-btn-up-" + f, b, "up");
                        else if (l === "vmouseover" || l === "focus") k ? i = setTimeout(function () {
                            e(j, "ui-btn-up-" + f, "ui-btn-hover-" + f, !0, "")
                        }, g) : e(j, "ui-btn-up-" + f, "ui-btn-hover-" + f, !0, "");
                        else if (l === "vmouseout" || l === "blur" || l === "scrollstart") e(j, "ui-btn-hover-" + f + " ui-btn-down-" + f, "ui-btn-up-" + f, !1, "up"), h && clearTimeout(h), i && clearTimeout(i)
                    }
                },
    ...
    function (a, b) {
        ...
        a.widget("mobile.listview", a.mobile.widget, {
            ...
            refresh: function (b) {
                ...
                l && m && e.find(".ui-li-dec").remove(), l && (n || n === 0 ? m ? v = parseFloat(n) : (w = parseFloat(n) - 1, e.css("counter-reset", "listnumbering " + w)) : m && (v = 1)), d.theme || (d.theme = a.mobile.getInheritedTheme(this.element, "c"));
                for (var D = 0, E = k.length; D < E; D++) {
                    ...
                    if (b || !p.hasClass("ui-li")) {
                        ...
                        })))) : F ? (q += " ui-li-divider ui-bar-" + g, p.attr("role", "heading"), l && (n || n === 0 ? m ? v = parseFloat(n) : (x = parseFloat(n) - 1, p.css("counter-reset", "listnumbering " + x)) : m && (v = 1))) : q += " ui-li-static ui-btn-up-" + r
                    }
                ...
                }).addClass("ui-btn-up-" + (e.jqmData("counttheme") || this.options.countTheme) + " ui-btn-corner-all"), this._addThumbClasses(k), this._addThumbClasses(e.find(".ui-link-inherit")), this._refreshCorners(b), this._trigger("afterrefresh")
            },
    ...
    function (a, b) {
        ...
        }), a.widget("mobile.checkboxradio", a.mobile.checkboxradio, a.mobile.behaviors.formReset), a(c).bind("pagecreate create", function (b) {
    ...
    function (a, d) {
        ...
        a.widget("mobile.popup", a.mobile.widget, {
            ...
            _eatEventAndClose: function (a) {
                return a.preventDefault(), a.stopImmediatePropagation(), this.options.dismissable && this.close(), !1
            },
            ...
            _resizeTimeout: function () {
                this._isOpen ? this._expectResizeEvent() || (this._ui.container.hasClass("ui-popup-hidden") && (this._trigger("beforeposition"), this._ui.container.removeClass("ui-popup-hidden").offset(this._placementCoords(this._desiredCoords(d, d, "window")))), this._resizeScreen(), this._resizeData = null, this._orientationchangeInProgress = !1) : (this._resizeData = null, this._orientationchangeInProgress = !1)
            },
            ...
            _handleDocumentFocusIn: function (b) {
                if (this._isOpen && b.target !== this._ui.container[0] && 0 === a(b.target).parents().filter(this._ui.container[0]).length) return this._ui.container.focus(), b.preventDefault(), b.stopImmediatePropagation(), !1
            },
            _create: function () {
                var e = {
                    ...
                    h = this;
                this.options.history = this.options.history && a.mobile.ajaxEnabled && a.mobile.hashListeningEnabled, f.length === 0 && (f = a("body")), this.options.container = this.options.container || a.mobile.pageContainer, f.append(e.screen), e.container.insertAfter(e.screen), e.placeholder.insertAfter(this.element), g && (e.screen.attr("id", g + "-screen"), e.container.attr("id", g + "-popup"), e.placeholder.html("<!-- placeholder for " + g + " -->")), e.container.append(this.element), this.element.addClass("ui-popup"), a.extend(this, {
                    _page: f,
                    _ui: e,
                    _fallbackTransition: "",
                    ...
                    h.options[a] = d, h._setOption(a, b, !0)
                }), e.screen.bind("vclick", a.proxy(this, "_eatEventAndClose")), this._on(a(b), {
            ...
            _completeOpen: function () {
                this._ui.container.attr("tabindex", "0").focus(), this._expectResizeEvent(), this._trigger("afteropen")
            },
            _openPrereqsComplete: function () {
                this._ui.container.addClass("ui-popup-active"), this._isOpen = !0, this._resizeScreen(), setTimeout(a.proxy(this, "_completeOpen"))
            },
            _open: function (c) {
                var d, e, f = function () {
                        var a = b,
            ...
            _closePrereqsDone: function () {
                var b = this.options;
                this._ui.container.removeAttr("tabindex"), b.container.unbind(b.closeEvents), this.element.undelegate(b.closeLinkSelector, b.closeLinkEvents), a.mobile.popup.active = d, this._trigger("afterclose")
            },
            _close: function (b) {
                this._ui.container.removeClass("ui-popup-active"), this._page.removeClass("ui-popup-open"), this._isOpen = !1, this._createPrereqs(a.proxy(this, "_closePrereqScreen"), a.proxy(this, "_closePrereqContainer"), a.proxy(this, "_closePrereqsDone")), this._animate({
                    ...
                    transition: b ? "none" : this._currentTransition || this.options.transition,
                    classToRemove: "in",
            ...
            _unenhance: function () {
                this._setTheme("none"), this.element.insertAfter(this._ui.placeholder).removeClass("ui-popup ui-overlay-shadow ui-corner-all"), this._ui.screen.remove(), this._ui.container.remove(), this._ui.placeholder.remove()
            },
            _destroy: function () {
                a.mobile.popup.active === this ? (this.element.one("popupafterclose", a.proxy(this, "_unenhance")), this.close()) : this._unenhance()
            },
            _closePopup: function (b, c) {
                var d, e;
                if (b.type === "pagebeforechange" && c) {
                    typeof c.toPage == "string" ? d = c.toPage : d = c.toPage.jqmData("url"), d = a.mobile.path.parseUrl(d), e = d.pathname + d.search + d.hash, this._myUrl !== e ? (this.options.container.unbind(this.options.closeEvents), this._close(!0)) : this._close();
                    return
                }
                this._close()
            },
            ...
            open: function (b) {
                ...
                g = a.mobile.dialogHashKey, h = a.mobile.activePage, i = h.is(".ui-dialog"), this._myUrl = f = a.mobile.urlHistory.getActive().url, j = f.indexOf(g) > -1 && !i, k = a.mobile.urlHistory;
                if (j) {
                    c._open(b), c._bindContainerClose();
                    return
                }
                f = f + g, k.activeIndex === 0 && f === k.initialDst && (f += g), e.container.one(e.navigateEvents, function (a) {
    ...
    function (a, b) {
        ...
        a.mobile.listview.prototype.options.filterCallback = d, a(c).delegate(":jqmData(role='listview')", "listviewcreate", function () {
            ...
            c.options.filterReveal && b.children().addClass("ui-screen-hidden");
            var e = a("<form>", {
                ...
                f = a("<input>", {
                    ...
                    c._trigger("beforefilter", "beforefilter", {
                        input: this
                    }), e.jqmData("lastval", f), l || f.length < h.length || f.indexOf(h) !== 0 ? g = b.children() : (g = b.children(":not(.ui-screen-hidden)"), !g.length && c.options.filterReveal && (g = b.children(".ui-screen-hidden")));
                    if (f) {
                    ...
                    } else g.toggleClass("ui-screen-hidden", !! c.options.filterReveal);
                    c._refreshCorners()
    ...
    function (a, d) {
        a.widget("mobile.slider", a.mobile.widget, {
            ...
            _create: function () {
                var e = this,
                    ...
                    l = this.isToggleSwitch ? "ui-slider-switch" : "",
                    m = f.attr("id"),
                    n = a("[for='" + m + "']"),
                    o = n.attr("id") || m + "-label",
                    p = n.attr("id", o),
                    q = this.isToggleSwitch ? 0 : parseFloat(f.attr("min")),
                    r = this.isToggleSwitch ? f.find("option").length - 1 : parseFloat(f.attr("max")),
                    ...
                    y = a(x),
                    z = f.jqmData("highlight") && !this.isToggleSwitch ? function () {
                        var b = c.createElement("div");
                        return b.className = "ui-slider-bg " + a.mobile.activeBtnClass + " ui-btn-corner-all", a(b).prependTo(y)
                    }() : !1,
                    A;
                v.setAttribute("href", "#"), x.setAttribute("role", "application"), x.className = ["ui-slider ", l, " ui-btn-down-", i, " ui-btn-corner-all", t, u].join(""), v.className = "ui-slider-handle", x.appendChild(v), w.buttonMarkup({
                    corners: !0,
                    theme: h,
                    shadow: !0
                }).attr({
                ...
                p.addClass("ui-slider"), f.addClass(this.isToggleSwitch ? "ui-slider-switch" : "ui-slider-input"), this._on(f, {
                ...
                }), y.insertAfter(f), this.isToggleSwitch && this.handle.bind({
                    focus: function () {
            ...
            _sliderVMouseDown: function (a) {
                return this.options.disabled ? !1 : (this.dragging = !0, this.userModified = !1, this.mouseMoved = !1, this.isToggleSwitch && (this.beforeStart = this.element[0].selectedIndex), this.refresh(a), this._trigger("start"), !1)
            },
            ...
            refresh: function (b, c, d) {
                ...
                var e = this.element,
                    f, g = !this.isToggleSwitch,
                    h = g ? [] : e.find("option"),
                    i = g ? parseFloat(e.attr("min")) : 0,
                    j = g ? parseFloat(e.attr("max")) : h.length - 1,
                    k = g && parseFloat(e.attr("step")) > 0 ? parseFloat(e.attr("step")) : 1;
                if (typeof b == "object") {
                    var l, m, n = b,
                        o = 8;
                    l = this.slider.offset().left, m = this.slider.width();
                    if (!this.dragging || n.pageX < l - o || n.pageX > l + m + o) return;
                    f = Math.round((n.pageX - l) / m * 100)
                } else b == null && (b = g ? parseFloat(e.val() || 0) : e[0].selectedIndex), f = (parseFloat(b) - i) / (j - i) * 100; if (isNaN(f)) return;
                f < 0 && (f = 0), f > 100 && (f = 100);
                var p = f / 100 * (j - i) + i,
                    q = (p - i) % k,
                    r = p - q;
                Math.abs(q) * 2 >= k && (r += q > 0 ? k : -k), p = parseFloat(r.toFixed(5)), p < i && (p = i), p > j && (p = j), this.handle.css("left", f + "%"), this.handle[0].setAttribute("aria-valuenow", g ? p : h.eq(p).attr("value")), this.handle[0].setAttribute("aria-valuetext", g ? p : h.eq(p).getEncodedText()), this.handle[0].setAttribute("title", g ? p : h.eq(p).getEncodedText()), this.valuebg && this.valuebg.css("width", f + "%");
                if (this._labels) {
                    var s = this.handle.width() / this.slider.width() * 100,
                        t = f && s + (100 - s) * f / 100,
                        u = f === 100 ? 0 : Math.min(s + 100 - t, 100);
                ...
                if (!d) {
                    var v = !1;
                    g ? (v = e.val() !== p, e.val(p)) : (v = e[0].selectedIndex !== p, e[0].selectedIndex = p), !c && v && e.trigger("change")
                }
            },
            enable: function () {
        ...
        }), a.widget("mobile.slider", a.mobile.slider, a.mobile.behaviors.formReset), a.widget("mobile.slider", a.mobile.slider, {
    ...
    function (a, d) {
        a.widget("mobile.selectmenu", a.mobile.widget, {
            ...
            _destroy: function () {
                ...
                a.length > 0 && (this.element.insertAfter(a), a.remove())
            },
            _create: function () {
        ...
        }), a.widget("mobile.selectmenu", a.mobile.selectmenu, a.mobile.behaviors.formReset), a(c).bind("pagecreate create", function (b) {
    ...
    function (a, d) {
        var e = function (e) {
            var f = e.select,
                ...
                h = e.selectID,
                i = e.label,
                j = e.select.closest(".ui-page"),
                k = e._selectOptions(),
                l = e.isMultiple = e.select[0].multiple,
                m = h + "-button",
                n = h + "-menu",
                o = a("<div data-" + a.mobile.ns + "role='dialog' data-" + a.mobile.ns + "theme='" + e.options.theme + "' data-" + a.mobile.ns + "overlay-theme='" + e.options.overlayTheme + "'>" + "<div data-" + a.mobile.ns + "role='header'>" + "<div class='ui-title'>" + i.getEncodedText() + "</div>" + "</div>" + "<div data-" + a.mobile.ns + "role='content'></div>" + "</div>"),
                p = a("<div>", {
                    "class": "ui-selectmenu"
                }).insertAfter(e.select).popup({
                    theme: e.options.overlayTheme
                }),
                q = a("<ul>", {
                    ...
                    role: "listbox",
                    "aria-labelledby": m
                }).attr("data-" + a.mobile.ns + "theme", e.options.theme).attr("data-" + a.mobile.ns + "divider-theme", e.options.dividerTheme).appendTo(p),
                r = a("<div>", {
                    "class": "ui-header ui-bar-" + e.options.theme
                }).prependTo(p),
                s = a("<h1>", {
                    "class": "ui-title"
                }).appendTo(r),
                t, u, v;
            e.isMultiple && (v = a("<a>", {
                text: e.options.closeText,
                href: "#",
                "class": "ui-btn-left"
            }).attr("data-" + a.mobile.ns + "iconpos", "notext").attr("data-" + a.mobile.ns + "icon", "delete").appendTo(r).buttonMarkup()), a.extend(e, {
                select: e.select,
                selectID: h,
                buttonId: m,
                menuId: n,
                ...
                build: function () {
                    var b = this;
                    b.refresh(), b._origTabIndex === d && (b._origTabIndex = b.select.attr("tabindex"), b._origTabIndex === d && (b._origTabIndex = !1)), b.select.attr("tabindex", "-1").focus(function () {
                        ...
                        switch (b.keyCode) {
                        case 38:
                            return f = d.prev().not(".ui-selectmenu-placeholder"), f.is(".ui-li-divider") && (f = f.prev()), f.length && (c.blur().attr("tabindex", "-1"), f.addClass("ui-btn-down-" + e.options.theme).find("a").first().focus()), !1;
                        case 40:
                            return g = d.next(), g.is(".ui-li-divider") && (g = g.next()), g.length && (c.blur().attr("tabindex", "-1"), g.addClass("ui-btn-down-" + e.options.theme).find("a").first().focus()), !1;
                        case 13:
                        case 32:
                ...
                open: function () {
                    function n() {
                        ...
                        b.length === 0 && (b = c.list.find("li.ui-btn:not( :jqmData(placeholder='true') ) a")), b.first().focus().closest("li").addClass("ui-btn-down-" + e.options.theme)
                    }
                    if (this.options.disabled) return;
                    var c = this,
                        d = a(b),
                    ...
                    }, 300), g > l - 80 || !a.support.scrollTop ? (c.menuPage.appendTo(a.mobile.pageContainer).page(), c.menuPageContent = o.find(".ui-content"), c.menuPageClose = o.find(".ui-header a"), c.thisPage.unbind("pagehide.remove"), j === 0 && k > l && c.thisPage.one("pagehide", function () {
                    ...
                    })) : (c.menuType = "overlay", c.listbox.one("popupafteropen", n).popup("open", {
                ...
                _buildList: function () {
                    ...
                    for (var u = 0; u < k; u++, s = !1) {
                        ...
                        f && (!v.getAttribute("value") || y.length === 0 || w.jqmData("placeholder")) && (f = !1, s = !0, v.hasAttribute(q) || (this._removePlaceholderAttr = !0), v.setAttribute(q, !0), d.hidePlaceholderMenuItems && A.push("ui-selectmenu-placeholder"), e || (e = b.placeholder = y));
                ...
                _destroy: function () {
                    this.close(), this._origTabIndex !== d && (this._origTabIndex !== !1 ? this.select.attr("tabindex", this._origTabIndex) : this.select.removeAttr("tabindex")), this._removePlaceholderAttr && this._selectOptions().removeAttr("data-" + a.mobile.ns + "placeholder"), this.listbox.remove(), g.apply(this, arguments)
                }
            })
        };
    ...
    function (a, d) {
        a.widget("mobile.fixedtoolbar", a.mobile.widget, {
                ...
                e.closest(".ui-page").bind("pagebeforeshow", function () {
                    ...
                    if (d.trackPersistentToolbars) {
                        ...
                        if (i.length || j.length) i.add(j).appendTo(a.mobile.pageContainer), f.nextPage.one("pageshow", function () {
                            j.prependTo(this), i.appendTo(this)
                        })
                    }
                })
            },
            ...
            updatePagePadding: function (b) {
                ...
                b = b || c.closest(".ui-page"), a(b).css("padding-" + (d ? "top" : "bottom"), c.outerHeight() + e)
            },
    ...
    function (a, b, d) {
        ...
        a.mobile.ajaxBlacklist && (a.mobile.ajaxEnabled = !1), e.addClass("ui-mobile ui-mobile-rendering"), setTimeout(h, 5e3), a.extend(a.mobile, {
            initializePage: function () {
                ...
                }), a.mobile.firstPage = d.first(), a.mobile.pageContainer = d.first().parent().addClass("ui-mobile-viewport"), g.trigger("pagecontainercreate"), a.mobile.showPageLoadingMsg(), h(), !a.mobile.hashListeningEnabled || !a.mobile.path.isHashValid(location.hash) || !a(f).is(':jqmData(role="page")') && !a.mobile.path.isPath(e) && e !== a.mobile.dialogHashKey ? (a.mobile.path.isHashValid(location.hash) && (a.mobile.urlHistory.initialDst = e.replace("#", "")), a.mobile.changePage(a.mobile.firstPage, {
                    transition: "none",
                    reverse: !0,
                    changeHash: !1,
                    fromHashChange: !0
